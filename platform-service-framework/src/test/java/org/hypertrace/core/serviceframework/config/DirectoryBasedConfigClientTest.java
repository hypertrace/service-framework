...
public class DirectoryBasedConfigClientTest {
  ...
  public void testReadConfig() {
    ...
    final DirectoryBasedConfigClient configClient = new DirectoryBasedConfigClient(
        configDirURL.getPath());
    ...
    Assertions.assertEquals("org.hypertrace.core.example.SamplePlatformService",
        config.getString("main.class"));
    Assertions.assertEquals(Arrays.asList("stdout", "file", "kafka"),
        config.getStringList("logger.names"));
    ...
    Assertions.assertEquals(Arrays.asList("console", "prometheus"),
